...
const CONFIG_RSI_7_MA_7 = {
  rsiLength: 7,
  maLength: 5,
  maType: 'SMA' // Can be SMA, EMA, WMA, VWMA
};

// Configuration for RSI(21)
const CONFIG_RSI_21 = {
  rsiLength: 21,
  maLength: 5, // Assuming MA(5) for RSI(21) as per previous discussion
  maType: 'SMA' // Can be SMA, EMA, WMA, VWMA
};
...
const MAX_FETCH_RETRIES = 5; // Maximum number of retries for fetching historical data
const FETCH_RETRY_DELAY_MS = 5000; // Delay between retries in milliseconds
